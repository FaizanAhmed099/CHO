...
//		
//		$('.menu-item').removeClass('mry-active');
//		$('.menu-item').find('.sub-menu').removeClass('mry-active');
//		
//		if ($(this).hasClass('menu-item-has-children') && !$(this).hasClass('mry-active')) {
//			console.log('not active');
//			$(this).addClass('mry-active');
//			$(this).find('.sub-menu').addClass('mry-active');
//		} else {
//			console.log('active');
//			$(this).removeClass('mry-active');
//			$(this).find('.sub-menu').removeClass('mry-active');
//		}
//	});
	
//	$('.menu-item').on('click', function () {
//		var index = $(this).index();
//		$('.menu-item').not(':eq('+index+')').removeClass('mry-active');
//		$('.menu-item').not(':eq('+index+')').find('.sub-menu').removeClass('mry-active');
//		$('.menu-item:eq('+active_menu+')').removeClass('mry-active');
//		$('.menu-item:eq('+active_menu+')').find('.sub-menu').removeClass('mry-active');
//		
//		$(this).toggleClass('mry-active');
//		$(this).children('.sub-menu').toggleClass('mry-active');
//		active_menu = index;
